/** @file
 *  @brief MAVLink comm protocol generated from minimal_IUCS2022.xml
 *  @see http://mavlink.org
 */
#pragma once
#ifndef MAVLINK_MINIMAL_IUCS2022_H
#define MAVLINK_MINIMAL_IUCS2022_H

#ifndef MAVLINK_H
    #error Wrong include order: MAVLINK_MINIMAL_IUCS2022.H MUST NOT BE DIRECTLY USED. Include mavlink.h from the same directory instead or set ALL AND EVERY defines from MAVLINK.H manually accordingly, including the #define MAVLINK_H call.
#endif

#define MAVLINK_MINIMAL_IUCS2022_XML_HASH -6818394748348981331
...
#define MAVLINK_ENABLED_MINIMAL_IUCS2022
...
typedef enum MAV_TYPE
{
   ...
   MAV_TYPE_IUSC_JUDGE_INTEGRAL_PROCESSING=61, /* IUCS2022_裁判-综合处理 | */
   MAV_TYPE_IUSC_JUDGE_TERMINAL_PROCESSING=62, /* IUCS2022_裁判-终端处理 | */
   MAV_TYPE_IUSC_JUDGE_INTEGRATED_DISPLAY=63, /* IUCS2022_裁判-综合显示 | */
   MAV_TYPE_IUSC_FIELD_OPTITRACK=64, /* IUCS2022_场地-定位系统 | */
   MAV_TYPE_IUSC_FIELD_DYNAMIC_OBSTACLE=65, /* IUCS2022_场地_动态障碍 | */
   MAV_TYPE_IUSC_FIELD_RESCUE_ROBOT=66, /* IUCS2022_场地_求救机器人 | */
   MAV_TYPE_IUSC_UAV_MISSION_COMPUTER=67, /* IUCS2022_无人机_任务计算机 | */
   MAV_TYPE_IUSC_UGV_DISPLAY_CONTROLLER=68, /* IUCS2022_无人车_显示控制器 | */
   MAV_TYPE_IUSC_UGV_MOTION_CONTROLLER=69, /* IUCS2022_无人车_运动控制器 | */
   MAV_TYPE_ENUM_END=70, /*  | */
} MAV_TYPE;
#endif
...
#if MAVLINK_MINIMAL_IUCS2022_XML_HASH == MAVLINK_PRIMARY_XML_HASH
...
#endif // __cplusplus
#endif // MAVLINK_MINIMAL_IUCS2022_H
