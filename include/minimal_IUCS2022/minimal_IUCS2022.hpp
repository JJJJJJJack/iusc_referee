...
enum class MAV_TYPE : uint8_t
{
    ...
    GPS=41, /* GPS | */
    WINCH=42, /* Winch | */
    IUSC_JUDGE_INTEGRAL_PROCESSING=61, /* IUCS2022_裁判-综合处理 | */
    IUSC_JUDGE_TERMINAL_PROCESSING=62, /* IUCS2022_裁判-终端处理 | */
    IUSC_JUDGE_INTEGRATED_DISPLAY=63, /* IUCS2022_裁判-综合显示 | */
    IUSC_FIELD_OPTITRACK=64, /* IUCS2022_场地-定位系统 | */
    IUSC_FIELD_DYNAMIC_OBSTACLE=65, /* IUCS2022_场地_动态障碍 | */
    IUSC_FIELD_RESCUE_ROBOT=66, /* IUCS2022_场地_求救机器人 | */
    IUSC_UAV_MISSION_COMPUTER=67, /* IUCS2022_无人机_任务计算机 | */
    IUSC_UGV_DISPLAY_CONTROLLER=68, /* IUCS2022_无人车_显示控制器 | */
    IUSC_UGV_MOTION_CONTROLLER=69, /* IUCS2022_无人车_运动控制器 | */
};

//! MAV_TYPE ENUM_END
constexpr auto MAV_TYPE_ENUM_END = 70;
