/** @file
 *	@brief MAVLink comm testsuite protocol generated from minimal_IUCS2022.xml
...
TEST(minimal_IUCS2022, HEARTBEAT)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::minimal_IUCS2022::msg::HEARTBEAT packet_in{};
    packet_in.type = 17;
    ...
    mavlink::minimal_IUCS2022::msg::HEARTBEAT packet1{};
    mavlink::minimal_IUCS2022::msg::HEARTBEAT packet2{};
...
#ifdef TEST_INTEROP
TEST(minimal_IUCS2022_interop, HEARTBEAT)
{
...
TEST(minimal_IUCS2022, PROTOCOL_VERSION)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::minimal_IUCS2022::msg::PROTOCOL_VERSION packet_in{};
    ...
    mavlink::minimal_IUCS2022::msg::PROTOCOL_VERSION packet1{};
    mavlink::minimal_IUCS2022::msg::PROTOCOL_VERSION packet2{};
...
#ifdef TEST_INTEROP
TEST(minimal_IUCS2022_interop, PROTOCOL_VERSION)
{
    mavlink_message_t msg;
