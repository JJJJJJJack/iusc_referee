/** @file
 *    @brief MAVLink comm protocol testsuite generated from common_IUCS2022.xml
 *    @see https://mavlink.io/en/
 */
#pragma once
#ifndef COMMON_IUCS2022_TESTSUITE_H
#define COMMON_IUCS2022_TESTSUITE_H
...
static void mavlink_test_minimal_IUCS2022(uint8_t, uint8_t, mavlink_message_t *last_msg);
static void mavlink_test_common_IUCS2022(uint8_t, uint8_t, mavlink_message_t *last_msg);

static void mavlink_test_all(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    mavlink_test_minimal_IUCS2022(system_id, component_id, last_msg);
    mavlink_test_common_IUCS2022(system_id, component_id, last_msg);
}
#endif

#include "../minimal_IUCS2022/testsuite.h"
...
static void mavlink_test_iusc_ctrl_obstacle_dyn(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_IUSC_CTRL_OBSTACLE_DYN >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_iusc_ctrl_obstacle_dyn_t packet_in = {
        93372036854775807ULL,73.0,101.0,129.0,157.0,77
    };
    mavlink_iusc_ctrl_obstacle_dyn_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.time_usec = packet_in.time_usec;
        packet1.control0 = packet_in.control0;
        packet1.control1 = packet_in.control1;
        packet1.control2 = packet_in.control2;
        packet1.control3 = packet_in.control3;
        packet1.state = packet_in.state;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_IUSC_CTRL_OBSTACLE_DYN_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_IUSC_CTRL_OBSTACLE_DYN_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_iusc_ctrl_obstacle_dyn_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_iusc_ctrl_obstacle_dyn_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_iusc_ctrl_obstacle_dyn_pack(system_id, component_id, &msg , packet1.time_usec , packet1.state , packet1.control0 , packet1.control1 , packet1.control2 , packet1.control3 );
    mavlink_msg_iusc_ctrl_obstacle_dyn_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_iusc_ctrl_obstacle_dyn_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_usec , packet1.state , packet1.control0 , packet1.control1 , packet1.control2 , packet1.control3 );
    mavlink_msg_iusc_ctrl_obstacle_dyn_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_iusc_ctrl_obstacle_dyn_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_iusc_ctrl_obstacle_dyn_send(MAVLINK_COMM_1 , packet1.time_usec , packet1.state , packet1.control0 , packet1.control1 , packet1.control2 , packet1.control3 );
    mavlink_msg_iusc_ctrl_obstacle_dyn_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("IUSC_CTRL_OBSTACLE_DYN") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_IUSC_CTRL_OBSTACLE_DYN) != NULL);
#endif
}

static void mavlink_test_iusc_ctrl_rescue_robot(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_IUSC_CTRL_RESCUE_ROBOT >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_iusc_ctrl_rescue_robot_t packet_in = {
        93372036854775807ULL,29,96
    };
    mavlink_iusc_ctrl_rescue_robot_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.time_usec = packet_in.time_usec;
        packet1.dummy_id = packet_in.dummy_id;
        packet1.state = packet_in.state;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_IUSC_CTRL_RESCUE_ROBOT_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_IUSC_CTRL_RESCUE_ROBOT_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_iusc_ctrl_rescue_robot_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_iusc_ctrl_rescue_robot_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_iusc_ctrl_rescue_robot_pack(system_id, component_id, &msg , packet1.time_usec , packet1.dummy_id , packet1.state );
    mavlink_msg_iusc_ctrl_rescue_robot_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_iusc_ctrl_rescue_robot_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_usec , packet1.dummy_id , packet1.state );
    mavlink_msg_iusc_ctrl_rescue_robot_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_iusc_ctrl_rescue_robot_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_iusc_ctrl_rescue_robot_send(MAVLINK_COMM_1 , packet1.time_usec , packet1.dummy_id , packet1.state );
    mavlink_msg_iusc_ctrl_rescue_robot_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("IUSC_CTRL_RESCUE_ROBOT") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_IUSC_CTRL_RESCUE_ROBOT) != NULL);
#endif
}

static void mavlink_test_iusc_ctrl_ugv_display_controller(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_IUSC_CTRL_UGV_DISPLAY_CONTROLLER >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_iusc_ctrl_ugv_display_controller_t packet_in = {
        93372036854775807ULL,29,96,163,230,41,108,175
    };
    mavlink_iusc_ctrl_ugv_display_controller_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.time_usec = packet_in.time_usec;
        packet1.state = packet_in.state;
        packet1.enable = packet_in.enable;
        packet1.char1 = packet_in.char1;
        packet1.char2 = packet_in.char2;
        packet1.char3 = packet_in.char3;
        packet1.char4 = packet_in.char4;
        packet1.char5 = packet_in.char5;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_IUSC_CTRL_UGV_DISPLAY_CONTROLLER_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_IUSC_CTRL_UGV_DISPLAY_CONTROLLER_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_iusc_ctrl_ugv_display_controller_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_iusc_ctrl_ugv_display_controller_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_iusc_ctrl_ugv_display_controller_pack(system_id, component_id, &msg , packet1.time_usec , packet1.state , packet1.enable , packet1.char1 , packet1.char2 , packet1.char3 , packet1.char4 , packet1.char5 );
    mavlink_msg_iusc_ctrl_ugv_display_controller_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_iusc_ctrl_ugv_display_controller_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_usec , packet1.state , packet1.enable , packet1.char1 , packet1.char2 , packet1.char3 , packet1.char4 , packet1.char5 );
    mavlink_msg_iusc_ctrl_ugv_display_controller_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_iusc_ctrl_ugv_display_controller_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_iusc_ctrl_ugv_display_controller_send(MAVLINK_COMM_1 , packet1.time_usec , packet1.state , packet1.enable , packet1.char1 , packet1.char2 , packet1.char3 , packet1.char4 , packet1.char5 );
    mavlink_msg_iusc_ctrl_ugv_display_controller_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("IUSC_CTRL_UGV_DISPLAY_CONTROLLER") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_IUSC_CTRL_UGV_DISPLAY_CONTROLLER) != NULL);
#endif
}

static void mavlink_test_iusc_ctrl_ugv_laser_status(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_IUSC_CTRL_UGV_LASER_STATUS >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_iusc_ctrl_ugv_laser_status_t packet_in = {
        93372036854775807ULL,29
    };
    mavlink_iusc_ctrl_ugv_laser_status_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.time_usec = packet_in.time_usec;
        packet1.state = packet_in.state;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_IUSC_CTRL_UGV_LASER_STATUS_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_IUSC_CTRL_UGV_LASER_STATUS_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_iusc_ctrl_ugv_laser_status_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_iusc_ctrl_ugv_laser_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_iusc_ctrl_ugv_laser_status_pack(system_id, component_id, &msg , packet1.time_usec , packet1.state );
    mavlink_msg_iusc_ctrl_ugv_laser_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_iusc_ctrl_ugv_laser_status_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_usec , packet1.state );
    mavlink_msg_iusc_ctrl_ugv_laser_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_iusc_ctrl_ugv_laser_status_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_iusc_ctrl_ugv_laser_status_send(MAVLINK_COMM_1 , packet1.time_usec , packet1.state );
    mavlink_msg_iusc_ctrl_ugv_laser_status_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("IUSC_CTRL_UGV_LASER_STATUS") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_IUSC_CTRL_UGV_LASER_STATUS) != NULL);
#endif
}

static void mavlink_test_iusc_ctrl_ugv_motion_controller(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_IUSC_CTRL_UGV_MOTION_CONTROLLER >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_iusc_ctrl_ugv_motion_controller_t packet_in = {
        93372036854775807ULL,963497880,17859,17963,18067,187,254,65
    };
    mavlink_iusc_ctrl_ugv_motion_controller_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.time_usec = packet_in.time_usec;
        packet1.can_id = packet_in.can_id;
        packet1.target_speed = packet_in.target_speed;
        packet1.target_heading = packet_in.target_heading;
        packet1.current_heading = packet_in.current_heading;
        packet1.frame_msg = packet_in.frame_msg;
        packet1.heart = packet_in.heart;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_IUSC_CTRL_UGV_MOTION_CONTROLLER_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_IUSC_CTRL_UGV_MOTION_CONTROLLER_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_iusc_ctrl_ugv_motion_controller_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_iusc_ctrl_ugv_motion_controller_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_iusc_ctrl_ugv_motion_controller_pack(system_id, component_id, &msg , packet1.time_usec , packet1.frame_msg , packet1.can_id , packet1.target_speed , packet1.target_heading , packet1.current_heading , packet1.heart , packet1.crc );
    mavlink_msg_iusc_ctrl_ugv_motion_controller_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_iusc_ctrl_ugv_motion_controller_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_usec , packet1.frame_msg , packet1.can_id , packet1.target_speed , packet1.target_heading , packet1.current_heading , packet1.heart , packet1.crc );
    mavlink_msg_iusc_ctrl_ugv_motion_controller_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_iusc_ctrl_ugv_motion_controller_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_iusc_ctrl_ugv_motion_controller_send(MAVLINK_COMM_1 , packet1.time_usec , packet1.frame_msg , packet1.can_id , packet1.target_speed , packet1.target_heading , packet1.current_heading , packet1.heart , packet1.crc );
    mavlink_msg_iusc_ctrl_ugv_motion_controller_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("IUSC_CTRL_UGV_MOTION_CONTROLLER") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_IUSC_CTRL_UGV_MOTION_CONTROLLER) != NULL);
#endif
}

static void mavlink_test_iusc_ctrl_ugv_motion_state(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_IUSC_CTRL_UGV_MOTION_STATE >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_iusc_ctrl_ugv_motion_state_t packet_in = {
        93372036854775807ULL,963497880,17859,175,242,53,120,187,254,65
    };
    mavlink_iusc_ctrl_ugv_motion_state_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.time_usec = packet_in.time_usec;
        packet1.can_id = packet_in.can_id;
        packet1.current_speed = packet_in.current_speed;
        packet1.frame_msg = packet_in.frame_msg;
        packet1.soc = packet_in.soc;
        packet1.error_level = packet_in.error_level;
        packet1.current_cmd_source = packet_in.current_cmd_source;
        packet1.backup = packet_in.backup;
        packet1.heart = packet_in.heart;
        packet1.crc = packet_in.crc;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_IUSC_CTRL_UGV_MOTION_STATE_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_IUSC_CTRL_UGV_MOTION_STATE_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_iusc_ctrl_ugv_motion_state_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_iusc_ctrl_ugv_motion_state_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_iusc_ctrl_ugv_motion_state_pack(system_id, component_id, &msg , packet1.time_usec , packet1.frame_msg , packet1.can_id , packet1.current_speed , packet1.soc , packet1.error_level , packet1.current_cmd_source , packet1.backup , packet1.heart , packet1.crc );
    mavlink_msg_iusc_ctrl_ugv_motion_state_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_iusc_ctrl_ugv_motion_state_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_usec , packet1.frame_msg , packet1.can_id , packet1.current_speed , packet1.soc , packet1.error_level , packet1.current_cmd_source , packet1.backup , packet1.heart , packet1.crc );
    mavlink_msg_iusc_ctrl_ugv_motion_state_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_iusc_ctrl_ugv_motion_state_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_iusc_ctrl_ugv_motion_state_send(MAVLINK_COMM_1 , packet1.time_usec , packet1.frame_msg , packet1.can_id , packet1.current_speed , packet1.soc , packet1.error_level , packet1.current_cmd_source , packet1.backup , packet1.heart , packet1.crc );
    mavlink_msg_iusc_ctrl_ugv_motion_state_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("IUSC_CTRL_UGV_MOTION_STATE") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_IUSC_CTRL_UGV_MOTION_STATE) != NULL);
#endif
}

static void mavlink_test_iusc_ctrl_mission_state(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_IUSC_CTRL_MISSION_STATE >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_iusc_ctrl_mission_state_t packet_in = {
        93372036854775807ULL,29,96,163
    };
    mavlink_iusc_ctrl_mission_state_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.time_usec = packet_in.time_usec;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_IUSC_CTRL_MISSION_STATE_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_IUSC_CTRL_MISSION_STATE_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_iusc_ctrl_mission_state_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_iusc_ctrl_mission_state_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_iusc_ctrl_mission_state_pack(system_id, component_id, &msg , packet1.time_usec , packet1.uav_id , packet1.armed , packet1.stage );
    mavlink_msg_iusc_ctrl_mission_state_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_iusc_ctrl_mission_state_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_usec , packet1.uav_id , packet1.armed , packet1.stage );
    mavlink_msg_iusc_ctrl_mission_state_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_iusc_ctrl_mission_state_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_iusc_ctrl_mission_state_send(MAVLINK_COMM_1 , packet1.time_usec , packet1.uav_id , packet1.armed , packet1.stage );
    mavlink_msg_iusc_ctrl_mission_state_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("IUSC_CTRL_MISSION_STATE") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_IUSC_CTRL_MISSION_STATE) != NULL);
#endif
}

static void mavlink_test_iusc_ctrl_mission_ugv_position(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_IUSC_CTRL_MISSION_UGV_POSITION >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_iusc_ctrl_mission_ugv_position_t packet_in = {
    ...
    mavlink_iusc_ctrl_mission_ugv_position_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.time_usec = packet_in.time_usec;
        packet1.UGV0_pos_x = packet_in.UGV0_pos_x;
        packet1.UGV0_pos_y = packet_in.UGV0_pos_y;
        packet1.UGV1_pos_x = packet_in.UGV1_pos_x;
        packet1.UGV1_pos_y = packet_in.UGV1_pos_y;
        packet1.UGV2_pos_x = packet_in.UGV2_pos_x;
        packet1.UGV2_pos_y = packet_in.UGV2_pos_y;
        packet1.UGV3_pos_x = packet_in.UGV3_pos_x;
        packet1.UGV3_pos_y = packet_in.UGV3_pos_y;
        packet1.UGV4_pos_x = packet_in.UGV4_pos_x;
        packet1.UGV4_pos_y = packet_in.UGV4_pos_y;
        packet1.UGV5_pos_x = packet_in.UGV5_pos_x;
        packet1.UGV5_pos_y = packet_in.UGV5_pos_y;
        packet1.UGV6_pos_x = packet_in.UGV6_pos_x;
        packet1.UGV6_pos_y = packet_in.UGV6_pos_y;
        packet1.UGV7_pos_x = packet_in.UGV7_pos_x;
        packet1.UGV7_pos_y = packet_in.UGV7_pos_y;
        packet1.UGV8_pos_x = packet_in.UGV8_pos_x;
        packet1.UGV8_pos_y = packet_in.UGV8_pos_y;
        packet1.UGV9_pos_x = packet_in.UGV9_pos_x;
        packet1.UGV9_pos_y = packet_in.UGV9_pos_y;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_IUSC_CTRL_MISSION_UGV_POSITION_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_IUSC_CTRL_MISSION_UGV_POSITION_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_iusc_ctrl_mission_ugv_position_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_iusc_ctrl_mission_ugv_position_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_iusc_ctrl_mission_ugv_position_pack(system_id, component_id, &msg , packet1.time_usec , packet1.UGV0_pos_x , packet1.UGV0_pos_y , packet1.UGV1_pos_x , packet1.UGV1_pos_y , packet1.UGV2_pos_x , packet1.UGV2_pos_y , packet1.UGV3_pos_x , packet1.UGV3_pos_y , packet1.UGV4_pos_x , packet1.UGV4_pos_y , packet1.UGV5_pos_x , packet1.UGV5_pos_y , packet1.UGV6_pos_x , packet1.UGV6_pos_y , packet1.UGV7_pos_x , packet1.UGV7_pos_y , packet1.UGV8_pos_x , packet1.UGV8_pos_y , packet1.UGV9_pos_x , packet1.UGV9_pos_y );
    mavlink_msg_iusc_ctrl_mission_ugv_position_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_iusc_ctrl_mission_ugv_position_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_usec , packet1.UGV0_pos_x , packet1.UGV0_pos_y , packet1.UGV1_pos_x , packet1.UGV1_pos_y , packet1.UGV2_pos_x , packet1.UGV2_pos_y , packet1.UGV3_pos_x , packet1.UGV3_pos_y , packet1.UGV4_pos_x , packet1.UGV4_pos_y , packet1.UGV5_pos_x , packet1.UGV5_pos_y , packet1.UGV6_pos_x , packet1.UGV6_pos_y , packet1.UGV7_pos_x , packet1.UGV7_pos_y , packet1.UGV8_pos_x , packet1.UGV8_pos_y , packet1.UGV9_pos_x , packet1.UGV9_pos_y );
    mavlink_msg_iusc_ctrl_mission_ugv_position_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_iusc_ctrl_mission_ugv_position_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_iusc_ctrl_mission_ugv_position_send(MAVLINK_COMM_1 , packet1.time_usec , packet1.UGV0_pos_x , packet1.UGV0_pos_y , packet1.UGV1_pos_x , packet1.UGV1_pos_y , packet1.UGV2_pos_x , packet1.UGV2_pos_y , packet1.UGV3_pos_x , packet1.UGV3_pos_y , packet1.UGV4_pos_x , packet1.UGV4_pos_y , packet1.UGV5_pos_x , packet1.UGV5_pos_y , packet1.UGV6_pos_x , packet1.UGV6_pos_y , packet1.UGV7_pos_x , packet1.UGV7_pos_y , packet1.UGV8_pos_x , packet1.UGV8_pos_y , packet1.UGV9_pos_x , packet1.UGV9_pos_y );
    mavlink_msg_iusc_ctrl_mission_ugv_position_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("IUSC_CTRL_MISSION_UGV_POSITION") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_IUSC_CTRL_MISSION_UGV_POSITION) != NULL);
#endif
}

static void mavlink_test_iusc_ctrl_mission_uav_signal_state(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_IUSC_CTRL_MISSION_UAV_SIGNAL_STATE >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_iusc_ctrl_mission_uav_signal_state_t packet_in = {
        93372036854775807ULL,73.0,101.0,129.0,157.0,185.0,213.0
    };
    mavlink_iusc_ctrl_mission_uav_signal_state_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.time_usec = packet_in.time_usec;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_IUSC_CTRL_MISSION_UAV_SIGNAL_STATE_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_IUSC_CTRL_MISSION_UAV_SIGNAL_STATE_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_iusc_ctrl_mission_uav_signal_state_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_iusc_ctrl_mission_uav_signal_state_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_iusc_ctrl_mission_uav_signal_state_pack(system_id, component_id, &msg , packet1.time_usec , packet1.pos_x , packet1.pos_y , packet1.pos_z , packet1.roll , packet1.pitch , packet1.yaw );
    mavlink_msg_iusc_ctrl_mission_uav_signal_state_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_iusc_ctrl_mission_uav_signal_state_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_usec , packet1.pos_x , packet1.pos_y , packet1.pos_z , packet1.roll , packet1.pitch , packet1.yaw );
    mavlink_msg_iusc_ctrl_mission_uav_signal_state_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_iusc_ctrl_mission_uav_signal_state_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_iusc_ctrl_mission_uav_signal_state_send(MAVLINK_COMM_1 , packet1.time_usec , packet1.pos_x , packet1.pos_y , packet1.pos_z , packet1.roll , packet1.pitch , packet1.yaw );
    mavlink_msg_iusc_ctrl_mission_uav_signal_state_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("IUSC_CTRL_MISSION_UAV_SIGNAL_STATE") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_IUSC_CTRL_MISSION_UAV_SIGNAL_STATE) != NULL);
#endif
}

static void mavlink_test_iusc_ctrl_mission_uav_laser_ctrl(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_IUSC_CTRL_MISSION_UAV_LASER_CTRL >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_iusc_ctrl_mission_uav_laser_ctrl_t packet_in = {
        93372036854775807ULL,29,96
    };
    mavlink_iusc_ctrl_mission_uav_laser_ctrl_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.time_usec = packet_in.time_usec;
        packet1.laser_ctrl = packet_in.laser_ctrl;
        packet1.backup = packet_in.backup;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_IUSC_CTRL_MISSION_UAV_LASER_CTRL_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_IUSC_CTRL_MISSION_UAV_LASER_CTRL_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_iusc_ctrl_mission_uav_laser_ctrl_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_iusc_ctrl_mission_uav_laser_ctrl_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_iusc_ctrl_mission_uav_laser_ctrl_pack(system_id, component_id, &msg , packet1.time_usec , packet1.laser_ctrl , packet1.backup );
    mavlink_msg_iusc_ctrl_mission_uav_laser_ctrl_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_iusc_ctrl_mission_uav_laser_ctrl_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_usec , packet1.laser_ctrl , packet1.backup );
    mavlink_msg_iusc_ctrl_mission_uav_laser_ctrl_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_iusc_ctrl_mission_uav_laser_ctrl_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_iusc_ctrl_mission_uav_laser_ctrl_send(MAVLINK_COMM_1 , packet1.time_usec , packet1.laser_ctrl , packet1.backup );
    mavlink_msg_iusc_ctrl_mission_uav_laser_ctrl_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("IUSC_CTRL_MISSION_UAV_LASER_CTRL") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_IUSC_CTRL_MISSION_UAV_LASER_CTRL) != NULL);
#endif
}

static void mavlink_test_iusc_ctrl_mission_uav_gimbal_ctrl(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_IUSC_CTRL_MISSION_UAV_GIMBAL_CTRL >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_iusc_ctrl_mission_uav_gimbal_ctrl_t packet_in = {
        93372036854775807ULL,73.0,101.0,129.0,157.0,185.0,213.0,101,168
    };
    mavlink_iusc_ctrl_mission_uav_gimbal_ctrl_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.time_usec = packet_in.time_usec;
        packet1.roll = packet_in.roll;
        packet1.pitch = packet_in.pitch;
        packet1.yaw = packet_in.yaw;
        packet1.ang_order_roll = packet_in.ang_order_roll;
        packet1.ang_order_pitch = packet_in.ang_order_pitch;
        packet1.ang_order_yaw = packet_in.ang_order_yaw;
        packet1.ang_order_type = packet_in.ang_order_type;
        packet1.backup = packet_in.backup;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_IUSC_CTRL_MISSION_UAV_GIMBAL_CTRL_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_IUSC_CTRL_MISSION_UAV_GIMBAL_CTRL_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_iusc_ctrl_mission_uav_gimbal_ctrl_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_iusc_ctrl_mission_uav_gimbal_ctrl_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_iusc_ctrl_mission_uav_gimbal_ctrl_pack(system_id, component_id, &msg , packet1.time_usec , packet1.roll , packet1.pitch , packet1.yaw , packet1.ang_order_type , packet1.backup , packet1.ang_order_roll , packet1.ang_order_pitch , packet1.ang_order_yaw );
    mavlink_msg_iusc_ctrl_mission_uav_gimbal_ctrl_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_iusc_ctrl_mission_uav_gimbal_ctrl_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_usec , packet1.roll , packet1.pitch , packet1.yaw , packet1.ang_order_type , packet1.backup , packet1.ang_order_roll , packet1.ang_order_pitch , packet1.ang_order_yaw );
    mavlink_msg_iusc_ctrl_mission_uav_gimbal_ctrl_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_iusc_ctrl_mission_uav_gimbal_ctrl_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_iusc_ctrl_mission_uav_gimbal_ctrl_send(MAVLINK_COMM_1 , packet1.time_usec , packet1.roll , packet1.pitch , packet1.yaw , packet1.ang_order_type , packet1.backup , packet1.ang_order_roll , packet1.ang_order_pitch , packet1.ang_order_yaw );
    mavlink_msg_iusc_ctrl_mission_uav_gimbal_ctrl_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("IUSC_CTRL_MISSION_UAV_GIMBAL_CTRL") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_IUSC_CTRL_MISSION_UAV_GIMBAL_CTRL) != NULL);
#endif
}

static void mavlink_test_iusc_ctrl_mission_computer_ack(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_IUSC_CTRL_MISSION_COMPUTER_ACK >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_iusc_ctrl_mission_computer_ack_t packet_in = {
        93372036854775807ULL,93372036854776311ULL,53,120,187,254
    };
    mavlink_iusc_ctrl_mission_computer_ack_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.time_usec = packet_in.time_usec;
        packet1.time_recv = packet_in.time_recv;
        packet1.ack = packet_in.ack;
        packet1.uav_id = packet_in.uav_id;
        packet1.msg_ack = packet_in.msg_ack;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_IUSC_CTRL_MISSION_COMPUTER_ACK_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_IUSC_CTRL_MISSION_COMPUTER_ACK_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_iusc_ctrl_mission_computer_ack_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_iusc_ctrl_mission_computer_ack_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_iusc_ctrl_mission_computer_ack_pack(system_id, component_id, &msg , packet1.time_usec , packet1.ack , packet1.time_recv , packet1.uav_id , packet1.msg_ack , packet1.seq_ack );
    mavlink_msg_iusc_ctrl_mission_computer_ack_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_iusc_ctrl_mission_computer_ack_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_usec , packet1.ack , packet1.time_recv , packet1.uav_id , packet1.msg_ack , packet1.seq_ack );
    mavlink_msg_iusc_ctrl_mission_computer_ack_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_iusc_ctrl_mission_computer_ack_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_iusc_ctrl_mission_computer_ack_send(MAVLINK_COMM_1 , packet1.time_usec , packet1.ack , packet1.time_recv , packet1.uav_id , packet1.msg_ack , packet1.seq_ack );
    mavlink_msg_iusc_ctrl_mission_computer_ack_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("IUSC_CTRL_MISSION_COMPUTER_ACK") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_IUSC_CTRL_MISSION_COMPUTER_ACK) != NULL);
#endif
}

static void mavlink_test_common_IUCS2022(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_iusc_ctrl_obstacle_dyn(system_id, component_id, last_msg);
    mavlink_test_iusc_ctrl_rescue_robot(system_id, component_id, last_msg);
    mavlink_test_iusc_ctrl_ugv_display_controller(system_id, component_id, last_msg);
    mavlink_test_iusc_ctrl_ugv_laser_status(system_id, component_id, last_msg);
    mavlink_test_iusc_ctrl_ugv_motion_controller(system_id, component_id, last_msg);
    mavlink_test_iusc_ctrl_ugv_motion_state(system_id, component_id, last_msg);
    mavlink_test_iusc_ctrl_mission_state(system_id, component_id, last_msg);
    mavlink_test_iusc_ctrl_mission_ugv_position(system_id, component_id, last_msg);
    mavlink_test_iusc_ctrl_mission_uav_signal_state(system_id, component_id, last_msg);
    mavlink_test_iusc_ctrl_mission_uav_laser_ctrl(system_id, component_id, last_msg);
    mavlink_test_iusc_ctrl_mission_uav_gimbal_ctrl(system_id, component_id, last_msg);
    mavlink_test_iusc_ctrl_mission_computer_ack(system_id, component_id, last_msg);
}

#ifdef __cplusplus
}
#endif // __cplusplus
#endif // COMMON_IUCS2022_TESTSUITE_H
